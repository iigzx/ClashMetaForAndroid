...
import com.cmfa.common.compat.getColorCompat
import com.cmfa.common.compat.pendingIntentFlags
import com.cmfa.common.compat.startForegroundCompat
import com.cmfa.common.log.Log
import com.cmfa.common.util.intent
import com.cmfa.core.model.LogMessage
import com.cmfa.log.LogcatCache
import com.cmfa.log.LogcatWriter
import com.cmfa.service.RemoteService
import com.cmfa.service.remote.ILogObserver
import com.cmfa.service.remote.IRemoteService
import com.cmfa.service.remote.unwrap
import com.cmfa.util.logsDir
...
class LogcatService : Service(), CoroutineScope by CoroutineScope(Dispatchers.Default), IInterface {
    ...
    private fun createNotificationChannel() {
        NotificationManagerCompat.from(this)
            .createNotificationChannel(
                ...
                ).setName(getString(com.cmfa.design.R.string.clash_logcat)).build()
            )
    }
    ...
    private fun showNotification() {
        val notification = NotificationCompat
            ...
            .setSmallIcon(com.cmfa.service.R.drawable.ic_logo_service)
            .setColor(getColorCompat(com.cmfa.design.R.color.color_clash_light))
            .setContentTitle(getString(com.cmfa.design.R.string.clash_logcat))
            .setContentText(getString(com.cmfa.design.R.string.running))
            .setContentIntent(
